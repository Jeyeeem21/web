...
<div id="staff_management" class="space-y-6">
    <h2 class="text-xl font-medium text-gray-800">Staff Management</h2>
    ...
    <div class="border-b border-gray-200">
        <ul class="flex flex-wrap -mb-px text-sm">
            ...
            <li class="mr-2">
                <a href="index.php?page=staff_management" class="inline-block p-3 border-b-2 border-primary-600 text-primary-600">Staff</a>
            </li>
        </ul>
    </div>
    ...
    <div class="bg-white rounded-lg shadow p-6">
        ...
        <div class="overflow-x-auto">
            <table id="staffTable" class="min-w-full divide-y divide-gray-200 mobile-card-view">
                <thead>
                    <tr>
                ...
                <tbody class="divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50" id="staff-row-<?php echo $member['id']; ?>">
                        <td class="px-4 py-2">
                        ...
                        <td class="px-4 py-2">
                            <div class="text-sm text-gray-900"><?php echo htmlspecialchars($member['name']); ?></div>
                            <div class="text-xs text-gray-500"><?php echo htmlspecialchars($member['gmail']); ?></div>
                        </td>
                        <td class="px-4 py-2">
                            <div class="text-sm text-gray-900"><?php echo ucfirst($member['role']); ?></div>
                            <?php if ($member['role'] == 'doctor' && !empty($member['doctor_position'])): ?>
                            <div class="text-xs text-gray-500"><?php echo htmlspecialchars($member['doctor_position']); ?></div>
                            <?php endif; ?>
                        </td>
                        <td class="px-4 py-2">
                            <div class="text-sm text-gray-900"><?php echo htmlspecialchars($member['contact']); ?></div>
                        </td>
                        <td class="px-4 py-2 whitespace-nowrap text-sm">
                            <div class="flex space-x-1">
                                <button type="button" class="text-blue-600 hover:text-blue-800" onclick="openEditModal(<?php echo $member['id']; ?>)">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                    </svg>
                                </button>
                                <button type="button" class="text-red-600 hover:text-red-800" onclick="deleteStaff(<?php echo $member['id']; ?>)">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    ...
    <!-- Staff Modal -->
    <div id="staffModal" class="fixed inset-0 bg-gray-600 bg-opacity-50 hidden overflow-y-auto h-full w-full z-50">
        <div class="relative top-20 mx-auto p-5 border w-full max-w-md shadow-lg rounded-md bg-white">
            <div class="mt-3">
                <h3 class="text-lg font-medium text-gray-900" id="modalTitle">Add Staff</h3>
                <form id="staffForm" method="POST" enctype="multipart/form-data" class="mt-4">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="contact" id="contact" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                    </div>
                    
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700">Email</label>
                        <input type="email" name="gmail" id="gmail" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <select name="role" id="role" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500" onchange="toggleRoleFields()">
                    ...
                    <div id="doctorPositionDiv" class="mb-4 hidden">
                        ...
                        <select name="doctor_position_id" id="doctor_position_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-primary-500 focus:ring-primary-500">
